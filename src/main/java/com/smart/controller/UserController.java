...
//			upload the file to folder and update the name to contact
		...
		//message success.....
		session.setAttribute("message", new Message("Your contact is added successfully !! add more...","primary"));
...
//		System.out.println(Cid);
	...
	public String updateHandler(@ModelAttribute Contact contact,@RequestParam("profileImage") MultipartFile file,Model model,HttpSession session,Principal principal) {
		try {
			...
			session.setAttribute("message", new Message("Your contact is updated...","warning"));
...
//			//change password
			...
			session.setAttribute("message", new Message("Password successfully changed...","warning"));
		}else {
//			//error
...
//		 obj.put("reciept", "txn_123456");
		 ...
		 //if you want you can save this to your db
